...
export function contestCard(c, status) {
  ...
  if (c.virtual_url) actions.push(el('a', { class: 'btn ghost', href: c.virtual_url, style: bs, title: T('Refazer esta prova contra o placar oficial, no seu tempo', 'Redo this contest against the official scoreboard, in your own time') }, '🕹️ Virtual'));
