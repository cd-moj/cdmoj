...
export const MODULES = () => [
  ...
  { id: 'baloes', icon: '🎈', name: T('Balões', 'Balloons'),
    desc: T('Cor por problema, tarefa de balão na fila do staff, ★ primeiro da sede e retenção durante o freeze.',
      'Colour per problem, balloon task in the staff queue, ★ first of the site and holding during the freeze.'),
