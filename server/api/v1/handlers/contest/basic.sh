...
LOGIN_START_TIME=""; LOCALE=""; LOGIN_ENABLED=""; FREEZE_TIME=""
...
ok_json '{contest_id:$id, contest_name:$name, start_time:$start, end_time:$end,
          login_start_time:$lst, locale:$loc, login_enabled:$le, freeze_time:$fz}' \
  ...
  --argjson le "$le" --argjson fz "${FREEZE_TIME:-0}"
